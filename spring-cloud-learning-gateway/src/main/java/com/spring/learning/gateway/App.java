package com.spring.learning.gateway;
...
public class App {
	...
	//test by :  curl --dump-header - --header 'Host: www.hystrix.com' http://localhost:8080/delay/3
	@Bean
	public RouteLocator myAnotherRoutes(RouteLocatorBuilder builder) {
		return builder.routes()
	...
	public Mono<String> fallback() {
		return Mono.just("Hi, I am fallback");
	}
