...
import com.spring.learning.security.entity.AuthUserDetails;
import com.spring.learning.security.response.MessageCode;
import com.spring.learning.security.response.WsResponse;
...
public class AuthenticationSuccessHandler extends WebFilterChainServerAuthenticationSuccessHandler {
	...
	public Mono<Void> onAuthenticationSuccess(WebFilterExchange webFilterExchange, Authentication authentication) {
		...
		try {
			...
			result.addProperty("message", "Authorization Failed");
