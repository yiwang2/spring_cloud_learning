package com.spring.learning.security.response;
...
public enum MessageCode {
    ...
    COMMON_SUCCESS("0000_0","Successful"),
    COMMON_FAILURE("0000_1", "Fail"),
	COMMON_AUTHORIZED_FAILURE("0000_24", "Authorization Failed");
